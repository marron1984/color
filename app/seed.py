...
国内の飲食店に加え、海外店舗（シンガポール・NYC）への紹介例、
外国籍スタッフ（特定技能 等）・海外志向の日本人スタッフを含む。
"""
...
CLIENTS = [
    ...
    dict(name="SAKURA Dining (Singapore)", kind="new", industry="和食（海外）",
         contact_name="Tan Wei Ming", contact_email="hr@sakura.sg", phone="+65-6000-0009",
         notes="シンガポール新店の日本人スタッフ・店長候補を募集。ビザ支援あり"),
    dict(name="UMAMI New York", kind="new", industry="寿司（海外）",
         contact_name="John Carter", contact_email="jobs@umami.nyc", phone="+1-212-000-0010",
...
TALENTS = [
    ...
    dict(name="清水 ゆい", kana="シミズ ユイ",
         ...
         location="東京", availability="available",
         nationality="日本",
         languages=[{"name": "日本語", "level": 5}, {"name": "英語", "level": 2}],
         visa_status="", desired_countries=["日本"],
