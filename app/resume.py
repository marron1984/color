...
EXTRACTION_PROMPT = (
    "あなたは人材紹介会社のアシスタントです。"
    "添付の履歴書・職務経歴書から、人材登録に必要な情報を抽出し、"
    "次の JSON スキーマに厳密に従って日本語で出力してください。\n"
    "{\n"
    '  "name": "氏名(文字列)",\n'
    '  "kana": "フリガナ(不明なら空文字)",\n'
    '  "skills": [{"name": "スキル名", "level": 1〜5の整数}],\n'
    '  "experience_years": 実務経験年数(数値),\n'
    '  "desired_salary": 希望年収(万円・整数, 不明なら0),\n'
    '  "type_os": "職種タイプや役割(例: 調理長, ホール, 現場リーダー)",\n'
    '  "work_style": "onsite / online / both のいずれか",\n'
...
# 簡易辞書：テキストに含まれていれば拾う代表的なスキル
_SKILL_VOCAB = [
    "溶接", "鉄骨組立", "配管", "電気工事", "CNC加工", "図面読解", "品質管理", "CAD",
    "内装仕上げ", "クロス貼り", "クレーン操作", "衛生管理",
    "ホール接客", "接客", "調理", "仕込み", "レジ", "ドリンク", "バリスタ", "ラテアート",
    "メニュー開発", "店舗管理", "原価管理", "マネジメント",
]
